...
export default {
    ...
    methods:{
        ...
        afterDeleteFollowing(){
            this.followers = this.followers.filter(obj => obj.id !== this.loginUser.id)
        }
    },
    created(){
        this.fetchProfile()
    ...
    computed: {
        isMe(){
            return dummyUser.id === this.user.id ? true : false
        },
        isFollowers(){
            return this.followers.some(obj => obj.id === dummyUser.id)
        }
    }
}
</script>